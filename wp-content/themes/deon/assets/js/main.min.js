! function(a) {
    ...
    }), a(document).on("deon_trigger_get_new_posts", function() {
        _.init(), o.init()
    });
    var i = {
            init: function() {
        ...
        _ = {
            ...
            getOptions: function(e, t) {
                ...
                h || (a < 2 ? g = y = w = q = a : a < 3 ? y = w = q = a : a < 4 ? w = q = a : a < 5 && (q = a));
                a = {
                    direction: o,
                ...
                return u.length && "fade" === u && (a.effect = "fade", a.fadeEffect = {
                    crossFade: !0
                }), Object.assign(a, _.getSliderDatas(e))
            },
            ...
            getEvents: function(o, n) {
                return {
                    on: {
                        ...
                        init: function() {
                            var t;
                            o.addClass("qodef-swiper--initialized"), qodef.body.trigger("deon_trigger_swiper_is_initialized", [o, n]), n.sliderScroll && (t = !1, o.on("mousewheel", function(e) {
        ...
        initGalleryPopup: function(e) {
            ...
            e.each(function(e) {
                a(this).magnificPopup({
                    ...
                    gallery: {
                        enabled: !0,
                        arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><span class="qodef-icon-linea-icons icon-arrows-right"></span></button>'
                    },
                    index: e,
                    type: "image",
                    image: {
    ...
    qodef.qodefAnchor = s, qodef.qodefWaitForImages = {
        check: function(e, t) {
            if (e.length) {
                var i = e.find("img");
                if (i.length)
...
function(o) {
    ...
    o(document).ready(function() {
        ...
        n.init()
    }), o(document).on("deon_trigger_get_new_posts", function(e, t) {
    ...
    var s = {
        ...
        setVisibility: function(e, t) {
            ...
            a.additional_query_args = {
                tax_query: t
            }, qodef.body.trigger("deon_trigger_load_more", [e, 1])
        },
...
function(r) {
    ...
    r(document).ready(function() {
        t.init()
    }), r(document).on("deon_trigger_get_new_posts", function() {
        t.init()
    });
    var t = {
        init: function() {
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        n.reInit()
    }), t(document).on("deon_trigger_get_new_posts", function(e, t) {
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        s.scroll()
    }), a(document).on("deon_trigger_load_more", function(e, t, i) {
    ...
    var s = {
        ...
        initStandard: function(i, e) {
            ...
            o.length && (t = i.data("options"), e = void 0 !== e && "" !== e ? parseInt(e, 10) : 1, s.changeStandardState(i, t.max_pages_num, e), o.children().each(function() {
                var t = a(this);
        ...
        changeStandardHtml: function(e, t, i, o) {
            var n, a;
            e.hasClass("qodef-pagination-type--standard") && (n = e.find(".qodef-m-pagination"), a = e.find(".qodef-m-pagination-spinner"), s.standardPaginationVisibility(n, t), n.remove(), a.remove(), e.append(o), s.initStandard(e, i))
        },
        ...
        getNewPosts: function(t, i) {
            ...
            s.setNextPageValue(n, i, !1), a.ajax({
                ...
                success: function(e) {
                    "success" === e.status ? (n.max_pages_num !== e.data.max_pages_num && (n.max_pages_num = e.data.max_pages_num), s.setNextPageValue(n, i, !0), s.changeStandardHtml(t, n.max_pages_num, i, e.data.pagination_html), s.addPosts(o, e.data.html, i), s.reInitMasonryPosts(t, o), setTimeout(function() {
                        qodef.body.trigger("deon_trigger_get_new_posts", [t, e.data, i])
                    }, 300), s.triggerStandardScrollAnimation(t), s.loadMoreButtonVisibility(t, n)) : console.log(e.message)
                },
                complete: function() {
