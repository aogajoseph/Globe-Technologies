! function(r) {
    ...
    r(window).on("elementor/frontend/init", function() {
        o.init(), e.init(), f.init(), t.init(), d.init()
    });
    var o = {
            init: function() {
        ...
        d = {
            init: function(e) {
                var o = e,
                    ...
                    i = {};
                if (t && void 0 !== e) {
                    var n = window.elementor.elements,
                        _ = o.data("id");
                    if (!n.models) return !1;
                    r.each(n.models, function(e, t) {
                        r.each(t.attributes.elements.models, function(e, t) {
                            _ == t.id && (i = t.attributes.settings.attributes)
                        })
                    ...
                    n = qodefElementorGlobal.vars.elementorColumnHandler;
                    r.each(n, function(e, t) {
                        o = r('[data-id="' + e + '"]'), a.background_text = t[0], a.background_text_color = t[1], a.background_text_size = t[2], a.background_text_size_1440 = t[3], a.background_text_size_1366 = t[4], a.background_text_size_1024 = t[5], a.background_text_vertical_offset = t[6], a.background_text_vertical_offset_1440 = t[7], a.background_text_vertical_offset_1366 = t[8], a.background_text_vertical_offset_1024 = t[9], a.background_text_horizontal_align = t[10], a.background_text_vertical_align = t[11], void 0 !== a.background_text && (a.background_text_enable = "yes"), void 0 !== o && o.length && d.generateOutput(o, a)
                    })
                }
